class Level1Scene extends Phaser.Scene {
    ...
    create() {
        // Set up the level
        this.add.text(400, 50, 'Level 1: The Awakening', { 
            fontFamily: 'Arial', 
            fontSize: '32px', 
            color: '#ffffff',
            stroke: '#000000',
        ...
        this.objectiveText = this.add.text(400, 100, 'Objective: Help Hang Yi escape the school using telekinesis', { 
            fontFamily: 'Arial', 
            fontSize: '18px', 
            color: '#ffffff',
        ...
        // Add a button to proceed to level 2 (for testing)
        const nextButton = this.add.text(700, 50, 'Next Level', { 
            fontFamily: 'Arial', 
            fontSize: '16px', 
            color: '#ffffff',
    ...
    createWorld() {
        ...
        const fireObject = this.interactiveObjects.create(700, 100, 'movable-box').setTint(0xff0000);
        fireObject.canBeAffectedBy = ['water'];
        fireObject.applyElement = function(element) {
            if (element === 'water') {
        ...
        const iceObject = this.interactiveObjects.create(800, 100, 'movable-box').setTint(0x00ffff);
        iceObject.canBeAffectedBy = ['fire'];
        iceObject.applyElement = function(element) {
            if (element === 'fire') {
                this.setTint(0x888888);
                this.melted = true;
            }
    ...
    createCharacters() {
        ...
        this.characters = [this.hangYi, this.xinNa];
